...
CREATE INDEX ON inbound.call_logs (organization_id, created_at DESC);
CREATE INDEX ON inbound.call_logs (agent_id);
...
CREATE INDEX ON inbound.leads (organization_id, created_at DESC);
