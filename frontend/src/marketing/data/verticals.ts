...
export const VERTICAL_PAGES: Record<string, VerticalPage> = {
  contractors: {
    ...
    type: 'vertical-full',
    title: 'Q-UP.AI for Contractors & Trades',
  ...
  'commercial-cleaning': {
    ...
    categorySlug: 'home-services',
    type: 'vertical-full',
    title: 'Q-UP.AI for Commercial Cleaning & Janitorial',
  ...
  'moving-storage': {
    ...
    categorySlug: 'home-services',
    type: 'vertical-full',
    title: 'Q-UP.AI for Moving & Storage',
  ...
  towing: {
    ...
    title: 'Q-UP.AI for Towing Companies',
  ...
  'auto-body-tire': {
    ...
    type: 'vertical-full',
    title: 'Q-UP.AI for Auto Body, Collision & Tire Shops',
  ...
  'car-dealerships': {
    ...
    categorySlug: 'automotive',
    type: 'vertical-full',
    title: 'Q-UP.AI for Car Dealerships',
  ...
  'property-management': {
    ...
    type: 'vertical-full',
    title: 'Q-UP.AI for Property Management',
  ...
  'residential-real-estate': {
    ...
    categorySlug: 'real-estate-property',
    type: 'vertical-full',
    title: 'Q-UP.AI for Real Estate Teams',
  ...
  'commercial-real-estate': {
    ...
    categorySlug: 'real-estate-property',
    type: 'vertical-full',
    title: 'Q-UP.AI for Commercial Real Estate',
  ...
  'personal-injury': {
    ...
    type: 'vertical-compact',
    title: 'Q-UP.AI for Personal Injury Lawyers',
  ...
  'healthcare-dental': {
    ...
    type: 'vertical-compact',
    title: 'Q-UP.AI for Healthcare & Dental',
  ...
  'saas-software': {
    ...
    type: 'vertical-compact',
    title: 'Q-UP.AI for SaaS & Software',
...
function ea(
  ...
  return {
    ...
    categorySlug,
    type: 'early-access',
    title: `Q-UP.AI — ${navLabel} | Get Early Access`,
