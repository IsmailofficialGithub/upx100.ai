...
export default function MarketingHomePage() {
  ...
  return (
    <MarketingShell>
      ...
      <section className="pt-36 pb-16 md:pt-40 md:pb-20 relative overflow-hidden">
        ...
        <div className="container-main relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-center">
            ...
            <p className="text-base text-[hsl(var(--muted-foreground))] leading-relaxed max-w-xl mb-7">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {['TCPA Compliant', 'PECR / TPS Verified', 'STIR/SHAKEN Attested', 'Compliance-Gated Pipeline'].map((chip) => (
                <span key={chip} className="inline-flex items-center gap-1.5 font-mono text-[10px] text-[hsl(var(--muted-foreground))] bg-up-dark-2 border border-up-dark-4 px-3 py-1.5 rounded">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              <button
                ...
                className="font-display font-bold text-sm bg-up-green text-up-on-green px-6 py-3 rounded-lg hover:shadow-[0_0_32px_rgba(0,255,136,0.15)] transition-all inline-flex items-center gap-2"
              >
                Start Your Campaign <ChevronRight size={16} />
              </button>
              <a href="#how-it-works" className="px-6 py-3 border border-up-dark-4 text-[hsl(var(--foreground))] text-sm font-semibold rounded-lg hover:bg-up-dark-2 transition-colors no-underline">
                See How It Works
              </a>
              <a href="#demo" className="text-sm text-[hsl(var(--muted-foreground))] no-underline hover:text-[hsl(var(--foreground))] transition-colors">
                Hear the AI Call You →
              </a>
            </div>
            <p className="font-mono text-[11px] text-[hsl(var(--muted-foreground))]">
              No contracts. No software to learn. <strong className="text-[hsl(var(--muted-foreground))]">Live in 30 days.</strong>
            </p>
          </div>
          ...
          <div className="mt-14 lg:mt-16 mkt-fade-up" style={{ transitionDelay: '0.24s' }}>
            ...
            {[
              ...
              <div key={m.label} className="bg-up-dark-1 p-5 text-center">
                <div className="font-mono text-[9px] text-[hsl(var(--muted-foreground))] uppercase tracking-wide mb-2">{m.label}</div>
      ...
      {/* Trust bar */}
      <div className="border-y border-up-dark-3 py-5 bg-up-dark-1 mkt-band">
        <div className="container-main flex flex-wrap justify-center gap-8 md:gap-10">
          {[
            ...
            <div key={s.label} className="text-center mkt-fade-up">
              ...
              <div className="font-mono text-[9px] text-[hsl(var(--muted-foreground))] uppercase tracking-wide mt-1">{s.label}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <section id="how-it-works" className="section-padding relative">
        <div className="container-main">
          <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-[hsl(var(--muted-foreground))] mb-4 mkt-fade-up">How It Works</p>
          ...
          <p className="text-[15px] text-[hsl(var(--muted-foreground))] max-w-xl mb-14 leading-relaxed mkt-fade-up">
      ...
      {/* Blueprints */}
      <section id="blueprints" className="section-padding bg-up-dark-1 border-y border-up-dark-3 mkt-band">
        <div className="container-main">
          <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-[hsl(var(--muted-foreground))] mb-4 mkt-fade-up">Built For Your Industry</p>
          <h2 className="font-display font-bold text-3xl md:text-[42px] tracking-tight mb-4 mkt-fade-up">We Already Know Your Market.</h2>
          <p className="text-[hsl(var(--muted-foreground))] max-w-xl mb-10 leading-relaxed mkt-fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {BLUEPRINTS.map((card, i) => (
              <Link
                key={card.label}
                to={card.href}
                className={`mkt-fade-up mkt-blueprint-card relative bg-gradient-to-br ${card.color} border border-up-dark-4 rounded-xl p-6 overflow-hidden group hover:border-up-green/30 transition-all no-underline text-inherit block`}
                style={{ transitionDelay: `${i * 0.08}s` }}
              >
                <div className="mkt-blueprint-scrim absolute inset-0 bg-black/40" />
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <span className="mkt-blueprint-label px-2.5 py-1 bg-white/10 rounded-full text-[10px] font-mono text-white/70">{card.label}</span>
                    <div className="mkt-blueprint-icon-wrap w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center">
                      <card.icon size={20} className="mkt-blueprint-icon text-white" />
                    </div>
                  </div>
                  <p className="mkt-blueprint-metric text-2xl font-display font-bold text-white mb-2">{card.metric}</p>
                  <p className="mkt-blueprint-desc text-[13px] text-white/90 leading-relaxed">{card.desc}</p>
      ...
      <section className="section-padding">
        <div className="container-main text-center mkt-fade-up">
          <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-[hsl(var(--muted-foreground))] mb-4">34 Verticals. One Platform.</p>
          <h2 className="font-display font-bold text-3xl md:text-[42px] tracking-tight mb-4">AI Sales Agents Built for Your Industry.</h2>
          <p className="text-[hsl(var(--muted-foreground))] max-w-xl mx-auto mb-8 leading-relaxed">
          ...
          <Link to="/industries" className="inline-flex font-display font-bold text-[15px] bg-up-green text-up-on-green px-8 py-3.5 rounded-lg no-underline hover:shadow-[0_0_32px_rgba(0,255,136,0.15)] transition-all">
      ...
      {/* Analytics preview */}
      <section id="analytics" className="section-padding bg-up-dark-1 border-y border-up-dark-3 mkt-band">
        <div className="container-main">
          <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-[hsl(var(--muted-foreground))] mb-4 mkt-fade-up">Your Analytics Portal</p>
          ...
          <div className="mkt-fade-up border border-up-dark-4 rounded-xl overflow-hidden bg-up-dark-1">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-up-dark-3 bg-up-dark-2">
              ...
              <span className="flex-1 font-mono text-[9px] text-[hsl(var(--muted-foreground))] text-center">portal.q-up.ai/dashboard</span>
            </div>
            <CampaignDashboardPreview />
            <div className="px-4 py-3 border-t border-up-dark-3 flex flex-wrap justify-between items-center gap-3 font-mono text-[10px] text-[hsl(var(--muted-foreground))]">
      ...
      <section id="demo" className="section-padding">
        <div className="container-main max-w-4xl">
          <div className="text-center mb-10">
            <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-[hsl(var(--muted-foreground))] mb-4 mkt-fade-up">Hear It For Yourself</p>
      ...
      {/* Pricing */}
      <section id="pricing" className="section-padding bg-up-dark-1 border-y border-up-dark-3 mkt-band">
        <div className="container-main">
          <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-[hsl(var(--muted-foreground))] mb-4 mkt-fade-up">Simple Pricing</p>
          ...
          <p className="text-[15px] text-[hsl(var(--muted-foreground))] max-w-2xl mb-12 leading-relaxed mkt-fade-up">
