...
const VoicePicker: React.FC<Props> = ({
  ...
  const selectedVoice = catalogMode ? VOICE_CATALOG.find((v) => v.id === value.toLowerCase()) : undefined;
    ...
    <div className={cn('space-y-3', className)}>
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <p className="text-[10px] text-[hsl(var(--muted-foreground))] leading-snug">
          ...
          Pick characteristics to narrow the catalog, then choose a voice by name. For your own voice, submit a{' '}

          ~60s sample for GCC approval (not a vendor ID).
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="text-xs font-semibold text-[hsl(var(--foreground))]">{voice.name}</span>
      ...
      <div className="pt-1 border-t border-[hsl(var(--border-v))] space-y-2">
              ...
              return (
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selected ? 'bg-[hsl(var(--primary))]/10' : 'hover:bg-[hsl(var(--muted))]/50',
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="block text-[10px] text-emerald-500/90">GCC approved · custom clone</span>
        ...
        {selectedClone && (
          ...
          <p className="text-[10px] text-[hsl(var(--foreground))] rounded-md border border-emerald-500/25 bg-emerald-500/5 px-2 py-1.5">
            ...
            Selected clone: <strong>{selectedClone.voice_name || 'Custom voice'}</strong>
        ...
        >
          ...
          {showCloneUpload ? 'Hide upload form' : 'Upload new voice sample (~60s) → HITL queue'}
